...
${GENPATCHES_URI}
https://github.com/HougeLangley/customkernel/releases/download/v5.16-patch/patch-5.16.0-xanmod1
...
PATCHES=( "${DISTDIR}/patch-5.16.0-xanmod1"
...
src_prepare() {
	...
	if	use	xanmod	;	then
		eapply "${DISTDIR}/patch-5.16.0-xanmod1"	||	die
