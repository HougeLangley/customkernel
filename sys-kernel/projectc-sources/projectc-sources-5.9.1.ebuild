...
UNIPATCH_LIST="${DISTDIR}/patch-5.9.1.xz ${DISTDIR}/prjc_v5.9-r0.xz ${DISTDIR}/mm59.xz ${DISTDIR}/elevator59.xz ${DISTDIR}/CPUf59.xz ${DISTDIR}/cpu59.xz ${DISTDIR}/75059.xz ${DISTDIR}/25659.xz ${DISTDIR}/UKSM59R4.xz ${DISTDIR}/zen59.xz"

KEYWORDS="~amd64"

src_prepare() {

	eapply "${FILESDIR}/r0fix.patch"
