...
UNIPATCH_LIST="${DISTDIR}/0001-patch-5.9.7.xz ${DISTDIR}/prjc_v5.9-r1.xz ${DISTDIR}/mm59.xz ${DISTDIR}/elevator59.xz ${DISTDIR}/CPUf59.xz ${DISTDIR}/cpu59.xz ${DISTDIR}/500.xz ${DISTDIR}/25659.xz ${DISTDIR}/UKSM59R5.xz ${DISTDIR}/zen59.xz"
