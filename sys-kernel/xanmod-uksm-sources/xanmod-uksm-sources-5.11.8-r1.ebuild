...
SRC_URI="
         ...
         https://github.com/HougeLangley/customkernel/releases/download/Kernel-v5.11.x/0001-patch-5.11.8-xanmod2.xz
         ${GENPATCHES_URI}
"

src_unpack() {
    UNIPATCH_LIST_DEFAULT=""
    UNIPATCH_LIST="${DISTDIR}/0001-patch-5.11.8-xanmod2.xz"
...
src_prepare() {
    ...
    eapply "${FILESDIR}/0011-08-Makefile.patch"
