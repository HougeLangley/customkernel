...
${KERNEL_BASE_URI}/patch-5.12.13.xz
${GENPATCHES_URI}
...
https://gitlab.com/sirlucjan/kernel-patches/-/raw/master/5.12/cpu-patches-v6/0001-cpu-patches.patch -> v6-graysky.patch
...
S="${WORKDIR}/linux-5.12.13-linux"

UNIPATCH_LIST_DEFAULT=( "${DISTDIR}/patch-5.12.13.xz" )
...
src_prepare() {
	...
	if	use	bmq	;	then
		...
		eapply "${DISTDIR}/v6-graysky.patch"	|| die
