...
UNIPATCH_LIST="${DISTDIR}/0001-patch-5.9.12.xz ${DISTDIR}/MuQSSv204.xz ${DISTDIR}/mm59.xz ${DISTDIR}/elevator59.xz ${DISTDIR}/CPUf59.xz ${DISTDIR}/cpu59.xz ${DISTDIR}/25659.xz ${DISTDIR}/UKSM59R5.xz ${DISTDIR}/zen59.xz"
