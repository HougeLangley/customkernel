...
UNIPATCH_LIST="${DISTDIR}/0001-patch-5.9.6.xz ${DISTDIR}/MuQSSv204.xz ${DISTDIR}/mm59.xz ${DISTDIR}/elevator59.xz ${DISTDIR}/CPUf59.xz ${DISTDIR}/cpu59.xz ${DISTDIR}/25659.xz ${DISTDIR}/UKSM59R5.xz ${DISTDIR}/zen59.xz"

KEYWORDS="~amd64"

src_prepare() {

    eapply "${FILESDIR}/0001-glitched-base.patch"
    eapply "${FILESDIR}/0002-glitched-muqss.patch"
    eapply "${FILESDIR}/0003-glitched-ondemand-muqss.patch"
