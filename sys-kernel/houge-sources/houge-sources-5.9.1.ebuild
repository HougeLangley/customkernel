...
UNIPATCH_LIST="${DISTDIR}/patch-5.9-ck1.xz ${DISTDIR}/mm59.xz ${DISTDIR}/elevator59.xz ${DISTDIR}/CPUf59.xz ${DISTDIR}/cpu59.xz ${DISTDIR}/500.xz ${DISTDIR}/25659.xz ${DISTDIR}/UKSM59R4.xz ${DISTDIR}/zen59.xz"
